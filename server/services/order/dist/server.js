...
async function start() {
    ...
    const restaurantRepository = new HttpRestaurantRepository(process.env.RESTAURANT_SERVICE_URL || "http://restaurant:3002");
    ...
    const userRepository = new HttpUserRepository(process.env.AUTH_SERVICE_URL || "http://auth:3001");
    const deliveryAssignmentService = new HttpDeliveryAssignmentService(process.env.DELIVERY_SERVICE_URL || "http://delivery:3004");
