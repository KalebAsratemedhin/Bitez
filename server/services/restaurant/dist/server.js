...
const restaurantController = new RestaurantController(restaurantUseCase, ratingRepository, cloudinary, menuRepository);
...
app.use("/rating", createRatingRoutes(restaurantController, ratingRepository, {
    deliveryServiceUrl,
    eventPublisher,
}));
